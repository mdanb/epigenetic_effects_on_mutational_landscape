...
cancer_types=("Skin-Melanoma" "ColoRect-AdenoCA" "multiple_myeloma" "CNS-GBM" "Lung-AdenoCA" "Lung-SCC")
...
pdftk "${cancer_types[@]}" cat output combined.pdf


pdfjam --nup 1x6 --landscape combined.pdf --outfile stitched.pdf
