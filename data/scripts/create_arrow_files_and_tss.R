...
if (dataset == "bing_ren") {
  ...
  files_dir = "/broad/hptmp/bgiotti/BingRen_scATAC_atlas/raw_dir/bed_files/bingren"
  ...
  create_arrow_files_and_tss("hg19", list.files(files_dir, full.names=T,
   ...
   files_dir = "/broad/hptmp/bgiotti/BingRen_scATAC_atlas/raw_dir/bed_files/greenleaf_pbmc_bm_scATAC"
   create_arrow_files_and_tss("hg38", list.files(files_dir, full.names=T,
                               pattern = "bgz$"), output_dir)
} else if (dataset == "greenleaf_brain") {
   output_dir = "/broad/hptmp/bgiotti/BingRen_scATAC_atlas/raw_dir/arrow/greenleaf_brain"
   files_dir = "/broad/hptmp/bgiotti/BingRen_scATAC_atlas/raw_dir/bed_files/greenleaf_brain_scATAC"
   create_arrow_files_and_tss("hg38", list.files(files_dir, full.names=T,
	                          pattern = "bgz$"), output_dir)

} else if (dataset == "tsankov") {
   output_dir = "/broad/hptmp/bgiotti/BingRen_scATAC_atlas/raw_dir/arrow/tsankov"
   files_dir = "/broad/hptmp/bgiotti/BingRen_scATAC_atlas/raw_dir/bed_files/Tsankov_scATAC"
   create_arrow_files_and_tss("hg38", list.files(files_dir, full.names=T,
	                                   pattern = "bgz$"), output_dir)
    ...
    create_arrow_files_and_tss("", list.files(files_dir, full.names=T,
	                          pattern = "bgz$"), output_dir)
}
