...
def load_mutations(meso, SCLC, lung_subtyped, woo_pcawg,
                   ...
                   expanded_hundred_kb, aggregated_per_donor, hierarchically_subtyped_mutations, mm):
    if meso:
...
def construct_scATAC_dir(scATAC_sources, scATAC_cell_number_filter, tss_filter, annotation_dir, hundred_kb,
    ...
    if all_seeds:
        ...
        scATAC_dir = "_".join((scATAC_dir, "seed", str(seed), "fold_for_test_set", str(fold_for_test_set + 1)))
