...
python3 prep_ML_model_scripts.py --cancer_types Lung-SCC --datasets Tsankov --scATAC_cell_number_filter=30 --annotation_dir=finalized_annotation --seed_interval=1-5 --seed_interval_step=5 --n_optuna_trials_prebackward_selection=50 --n_optuna_trials_backward_selection=50 --cores=2 --top_features_to_plot "19" "15" "10" "5" "2" --feature_importance_method=permutation_importance
