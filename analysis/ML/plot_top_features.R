...
cell_types = c("adult_brain ASCNT BR_Br" = "ASCNT, Adult Brain BR_Br",
               ...
               "bonemarrow Monocytes GL_BlBm" = "Monocytes, bonemarrow GL_BlBm", 
               "bonemarrow Pre.B GL_BlBm" = "Pre.B, bonemarrow GL_BlBm",
               "blood Monocytes GL_BlBm" = "Monocytes, blood GL_BlBm",
               "blood B GL_BlBm" = "B, Blood GL_BlBm",
               "brain late RG GL_Br" = "late RG, brain GL_Br",
               "brain mGPC GL_Br" = "mGPC, brain GL_Br",
               "brain OPC/Oligo GL_Br" = "OPC/Oligo, brain GL_Br",
               "brain nIPC GL_Br" = "nIPC, brain GL_Br",
               "cerebrum Astrocytes SH" = "Astrocytes, Fetal cerebrum SH",
               "cerebrum Astrocytes/Oligodendrocytes SH" = "Astrocytes/Oligo, Fetal Cerebrum SH",
               "cerebrum Vascular endothelial cells SH" = "Vascular endothelial, Fetal Cerebrum SH",
               "cerebellum Granule neurons SH" = "Granule neurons, Fetal cerebellum SH",
               "cerebellum Purkinje neurons SH" = "Purkinje neurons, Fetal cerebellum SH",
               ...
               "eye Ganglion cells SH" = "Ganglion cells, Eye SH",
          		 "fetal_lung Basal R_Fl" = "Basal, Fetal Lung R_Fl",
          		 "fetal_lung Late airway progenitor R_Fl" = "Late airway progenitor, Fetal Lung R_Fl",
          		 "fetal_lung Mid/late meso R_Fl" = "Mid/late meso, fetal_lung R_Fl", 
          		 "fetal_lung Adventitial fibro R_Fl" = "Adventitial fibro, fetal_lung R_Fl",
          		 "frontal_cortex Oligodendrocyte Precursor BR" = "Oligodendrocyte Precursor, Frontal Cortex BR",
               "frontal_cortex Astrocyte BR" = "Astrocyte, Frontal Cortex BR",
               ...
               "polyp_colon Stem GL_Co" = "Stem, Polyp Colon GL_Co",
          		 "polyp_colon Immature Enterocytes GL_Co" = "Immature Enterocytes, Polyp Colon GL_Co",
...
construct_top_feat_barplot <- function(df_test, savefile, savepath, width=12,
  ...
  p <- ggplot(df) +
    ...
    theme(
      ...
      axis.text.x = element_text(vjust = 0.5, hjust=1, size=100),
      axis.text.y = element_text(size=100, colour = color),
