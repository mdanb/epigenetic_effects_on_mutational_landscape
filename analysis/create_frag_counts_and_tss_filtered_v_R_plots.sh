...
if ! [ -f "../figures/sarcomatoid_Tsankov_all_cell_types.png" ]; then              
    ...
    --plot_x_ticks "1000,50000,100000,300000,400000,500000,1000000"
fi 

if ! [ -f "../figures/sarcomatoid_Tsankov_relevant_cells.png" ]; then           
    Rscript create_frag_counts_and_tss_filtered_v_R_plots.R \
    --cancer_type "sarcomatoid" \
    --waddell_sarc_biph \
    ...
    --tsse_filtered_cell_types "Basal;Ciliated;Secretory;Endothelial;Neuroendocrine;Ionocytes;Stromal;Tuft.like/SmoothMuscle;Fibroblasts;AT2;AT1;Endothelial;Ciliated;Mesothelium;Secretory" \
    --tissue_for_tsse_filtered_cell_types "Tsankov-Proximal Lung,Tsankov-Distal Lung" \
    --plot_filename "sarcomatoid_Tsankov_relevant_cells.png" \
    --plot_x_ticks "1000,25000,50000,75000,100000,200000,300000,400000,500000,1000000"
fi
