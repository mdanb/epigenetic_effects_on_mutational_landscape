...
# python3 ../analysis/ML/prep_ML_model_scripts.py --cancer_types Myeloid-AML --datasets NB --scATAC_cell_number_filter=0 --annotation_dir=Hu_Y_et_al_BM --dataset_abbrev N \
...
#                     --tissues_to_consider=all --woo_pcawg --add_p_to_file --add_perf_to_file --mem_per_core=1000 --submit_jobs
